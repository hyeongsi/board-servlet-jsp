		...
		<c:choose>
			<c:when test="${empty login}">
				<div class="col-md-3 text-end gap-3">
					<a href="loginMemberUI" class="btn btn-outline-primary">로그인</a>
					<a href="registerMemberUI" class="btn btn-primary">회원가입</a>
				</div>
			</c:when>
			<c:otherwise>
				<div class="col-md-3 text-end gap-3">
					<span class="fw-bold"><c:out value="${login.name} 님" /></span>
					<a href="myProfileUI" class="btn btn-outline-primary">내정보</a>
